          ...
          <div className="mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-10 lg:py-24">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-[var(--muted)]">
                Все работы создаются вручную на качественном холсте с
                использованием качественных красок и материалов. Каждая картина
                существует в одном экземпляре и сделана с вниманием, теплом и
                душой.
              </p>
            </div>
          </div>
